...
# `_unwinding_child.py` in a fresh interpreter. The child describes each case.
...
def test_dropped_during_exception(library: str, case: str) -> None:
    run_child("_unwinding_child.py", library, case, prints="ok")
